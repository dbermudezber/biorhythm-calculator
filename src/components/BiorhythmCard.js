...
function BioryhthmCard({birthDate, targetDate}) {
            ...
            <IonCardHeader>
                ...
                <IonCardContent>
                    ...
                    <p className="physical">
                        Physical: {biorhythms.physical.toFixed(4)}</p>
                    <p className="emotional">
                        Emotional: {biorhythms.emotional.toFixed(4)}</p>
                    <p className="intellectual">
                        Intellectual: {biorhythms.intellectual.toFixed(4)}</p>
                </IonCardContent>
        </IonCard>
    );
}

export default BioryhthmCard;